...
function zoom(classNames, settings) {
    ...
    document.addEventListener("touchstart", function() {
        if(!isScrolling() && (!targetScale || targetScale <= C_scaleMin)) {
            touchable = true;
        }
    });
    ...
    /****************************************************************************/
    function mouseEnter() {
        if(!touchable) disableScroll();
    }

    /* @-<mouseLeave ************************************************************/
    /****************************************************************************/
    function mouseLeave() {
        if(!touchable) enableScroll();
    }
    ...
    function touchStart(e) {
        ...
        if (e.touches.length == 1 && (!targetScale || targetScale <= C_scaleMin)) {
            return false;
        }
